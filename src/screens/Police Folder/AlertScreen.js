...
const MOCK_ALERTS = [
  { id: "1", title: "Severe Flash Flood", type: "Flood", status: "Active", location: "Sindhupalchok District", time: "25m ago", severity: "High", color: "#FF4D4D", lat: 27.76, lng: 85.66 },
  { id: "2", title: "River Level Overflow", type: "Flood", status: "Active", location: "Gorkha Municipality", time: "2h ago", severity: "High", color: "#FFB020", lat: 28.00, lng: 84.62 },
  { id: "3", title: "Landslide Warning", type: "Landslide", status: "Active", location: "Manang Region", time: "8h ago", severity: "Moderate", color: "#1E90FF", lat: 28.66, lng: 84.15 },
  { id: "4", title: "Heavy Monsoon History", type: "Flood", status: "Past", location: "Kathmandu Valley", time: "2d ago", severity: "Moderate", color: "#9ca3af", lat: 27.71, lng: 85.32 },
];
...
const styles = StyleSheet.create({
  ...
  notifDot: { position: 'absolute', top: 12, right: 12, width: 8, height: 8, borderRadius: 4, backgroundColor: '#ef4444', borderWidth: 2, borderColor: '#111827' },
  searchContainer: { backgroundColor: "#0b121f", marginHorizontal: 20, borderRadius: 16, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 15, height: 55, marginTop: 20, borderWidth: 1, borderColor: '#1f2937' },
  searchInput: { color: "#fff", marginLeft: 10, flex: 1, fontSize: 16 },
  filterWrapper: { height: 50, marginVertical: 15 },
  chip: { backgroundColor: '#111827', paddingHorizontal: 20, paddingVertical: 8, borderRadius: 12, marginRight: 10, height: 40, justifyContent: 'center', borderWidth: 1, borderColor: '#1f2937' },
  activeChip: { backgroundColor: '#1e90ff', borderColor: '#3b82f6' },
  chipText: { color: '#6b7280', fontWeight: 'bold', fontSize: 13 },
  tabContainer: { flexDirection: 'row', backgroundColor: "#0b121f", marginHorizontal: 20, borderRadius: 12, padding: 4, marginBottom: 20, borderWidth: 1, borderColor: '#1f2937' },
  tab: { flex: 1, paddingVertical: 10, alignItems: 'center', borderRadius: 10 },
  activeTab: { backgroundColor: '#1f2937' },
  tabText: { color: "#4b5563", fontWeight: '700' },
  activeTabText: { color: "#fff" },
  card: { backgroundColor: "#111827", borderRadius: 20, marginBottom: 15, flexDirection: 'row', overflow: 'hidden', elevation: 5 },
  severityBar: { width: 5 },
