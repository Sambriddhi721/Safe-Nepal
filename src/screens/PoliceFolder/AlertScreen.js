...
// Coordinates added per location for map use in AlertDetails
const MOCK_ALERTS = [
  {
    id: "1",
...
export default function AlertScreen({ navigation }) {
  ...
  // Safe navigation handler — works whether navigation is passed or not
    ...
    >
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.header}>
          ...
          <TouchableOpacity style={styles.bellBtn} onPress={handleGoBack}>
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <TouchableOpacity
              style={styles.card}
              onPress={() => handleNavigate("AlertDetails", { alert: item })}
              activeOpacity={0.85}
            >
              <View
                style={[styles.severityBar, { backgroundColor: item.color }]}
              />
          ...
          ListEmptyComponent={
            <View style={styles.emptyBox}>
              ...
              <Text style={styles.emptyText}>
                No alerts found in this sector.
              </Text>
            </View>
          }
        />
        ...
        <TouchableOpacity
          style={styles.fab}
          onPress={() => handleNavigate("ReportDisaster")}
        >
          <LinearGradient
            colors={["#1e90ff", "#0052D4"]}
