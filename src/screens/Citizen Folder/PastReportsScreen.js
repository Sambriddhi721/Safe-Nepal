...
const MOCK_REPORTS = [
  ...
  { id: "f3", category: "Flood", severity: "Low", location: "Butwal-6, Rupandehi", description: "Heavy rain causing street-level waterlogging.", timestamp: "2026-03-29 09:00" },
  ...
  { id: "l3", category: "Landslide", severity: "Low", location: "Nagarkot Hill Road", description: "Minor debris falling onto the road.", timestamp: "2026-03-28 16:50" }
];
...
export default function PastReportsScreen() {
  ...
  const fetchReports = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setAllReports(data.length > 0 ? data : MOCK_REPORTS);
      }
    } catch (error) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      {/* Tab Switcher (Columns Replacement) */}
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptyText}>No {activeTab.toLowerCase()} reports in this area.</Text>
          </View>
        }
      />
    </SafeAreaView>
...
const styles = StyleSheet.create({
  ...
  searchSection: { paddingHorizontal: 20, paddingTop: 20, marginBottom: 15 },
  searchContainer: { 
    flexDirection: 'row', 
    alignItems: 'center', 
